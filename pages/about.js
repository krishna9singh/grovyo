...
export default function About() {
  ...
  return (
    <>
    <Head>
        <title>About Us | Grovyo</title>
        <meta name="description" content="Grovyo is a web and app based platform designed and developed by Artimus Inc. in India." />
      ...
      <p>Grovyo is a web and app based platform designed and developed by Artimus Inc. in India.</p>
